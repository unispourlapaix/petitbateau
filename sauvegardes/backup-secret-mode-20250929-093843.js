...
⚡ Le jeu continue...`;
                ...
                if (distance < collisionRadius) {
                    ...
                    if (this.gameState) {
                        ...
                        if (this.gameState.score !== undefined) {
                            ...
                            // DEBUG: Vérifier que la variable globale score a bien changé
                            console.log(`🔍 APRÈS AJOUT: gameState.score = ${this.gameState.score}`);

                            // Forcer la synchronisation avec la variable globale
                            if (typeof window.score !== 'undefined') {
                                window.score = this.gameState.score;
                                console.log(`🔄 FORCÉ: window.score = ${window.score}`);
                            }
    ...
    renderMenu() {
        ...
        this.ctx.fillText('MODE SECRET', centerX, centerY - 40);
